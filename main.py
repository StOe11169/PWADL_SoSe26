...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_frames", type=int, default=64) #64->2
    parser.add_argument("--epochs", type=int, default=3) #15 ->2
    parser.add_argument("--n_trials", type=int, default=2) #40->2
